...
class ParamGroup:
    def __init__(self, parser: ArgumentParser, name : str, fill_none = False):
        ...
        for key, value in vars(self).items():  # vars ���ض���� __dict__ ����
            shorthand = False
            if key.startswith("_"):  # ɾ����ǰ���_
                shorthand = True
                key = key[1:]
            t = type(value)  # ��ȡֵ����������
            value = value if not fill_none else None  # �Ƿ�Ҫ��ֵ��ֵΪNone
            if shorthand:  # ����������д
                if t == bool:
...
class ModelParams(ParamGroup): 
    ...
    def extract(self, args):  # ���__init__���������õ�dict����{sh_degree:3, source_path:" ", ...}
        g = super().extract(args)
        g.source_path = os.path.abspath(g.source_path)  # ��g.source_path����Ϊ����·��
        return g
...
class ModelHiddenParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.bounds = 1.6 
        self.plane_tv_weight = 0.0001 # TV loss of spatial grid0.0001
        self.time_smoothness_weight = 0.01 # TV loss of temporal grid0.01
        self.l1_time_planes = 0.0001  # TV loss of temporal grid
        self.kplanes_config = {
                             'grid_dimensions': 2,
                             'input_coordinate_dim': 4,
                             'output_coordinate_dim': 32,
                             'resolution': [64, 64, 64, 25]  # [64,64,64]: resolution of spatial grid. 25: resolution of temporal grid, better to be half length of dynamic frames25
                            }
        ...
        self.no_ds=False # cancel the deformation of Gaussians' scaling  # dynamic-SLAM���ܲ���Ҫ����
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.deformation_lr_init = 0.00016#0.00022
        self.deformation_lr_final = 0.000016
        self.deformation_lr_delay_mult = 0.01
        self.grid_lr_init = 0.0016#0.0009
