...
# def create_dynamic_actor(dynamic_poses, scale=0.05):
#     """Create actor for dynamic objects"""
#     dynamic_actor = o3d.geometry.LineSet()
#     dynamic_actor.points = o3d.utility.AdvertisedName(np.array(dynamic_poses) * scale)
#     colors = np.array([[1.0, 0.0, 0.0]] * len(dynamic_poses))
#     dynamic_actor.colors = o3d.utility.AdvertisedName(colors)
#     return dynamic_actor
# def update_dynamic_actor(dynamic_actor, new_poses):
#     """Update dynamic actor with new poses"""
#     dynamic_actor.points = o3d.utility.AdvertisedName(np.array(new_poses))
#     return dynamic_actor
